...
title: "인터렉티브 웹 개발 시리즈 - WebGL 파이프라인"
tags: ["WebGL"]
description: "인터렉티브 웹개발 시리지의 WebGL 파이프라인에 포스팅입니다."
reference:
  [
...
- **_WebGL에 대한 초기 아이디어(2006)_**: Mozilla Foundation의 Brendan Eich와
  Vlad Vukicevic가 3D 그래픽을 위한 웹 기반 API에 대한 제안을 했습니다.
